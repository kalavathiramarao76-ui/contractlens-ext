export const QUICK_RISK_PROMPT = `You are ContractLens AI, a legal contract risk analysis expert. When given a contract clause:
...
export const FULL_ANALYZER_PROMPT = `You are ContractLens AI, an advanced contract analysis engine. Analyze the given contract text in depth:
...
export const RISK_SCORER_PROMPT = `You are ContractLens AI. Score the risk of each clause in the given contract:
...
export const CLAUSE_EXPLAINER_PROMPT = `You are ContractLens AI. Explain this contract clause in plain English:
...
export const COMPARISON_PROMPT = `You are ContractLens AI. Compare these contract clauses or contracts:
...
export const CONTENT_ANALYZE_PROMPT = `You are ContractLens AI. Analyze this contract/legal document:
1. **Risk Level**: HIGH / MEDIUM / LOW
